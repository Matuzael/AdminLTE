  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><strong>Cadastro de Clientes </strong></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-8" style="margin:auto;">
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="controllers/addCliente.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="cpf" type="text" class="form-control" id="exampleInputPassword1" placeholder="CPF">
                  </div>
              ...
              <div class="card-footer clearfix">
                <button type="submit" class="btn btn-info float-right"><i class="fas fa-plus"></i>Cadastrar Cliente</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
