          ...
          <div class="col-12">
            <div class="card">
              ...
              <?php 
                ...
                <td><span class="tag tag-success">'.$produto['quantidade'].'</span></td>
                <td><a href=controllers/removerProduto.php?id=';
                echo $produto['cod'];
              echo'> <img src="img/remover.png"/></a>


              <a href=atualizarProduto.php?id=';
                echo $produto['cod'];
              echo'> <img src="img/atualizar.png"/></a> </td>
                </tr>';
                endforeach;
              ?>
                  </tbody>
