  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><strong>Cadastro de Produtos </strong></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-8" style="margin:auto;">
          <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="controllers/addProduto.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="descricao" type="text" class="form-control" id="exampleInputEmail1" placeholder="Descrição">
                  </div>

                <div class="row">
                  <div class="form-group col-lg-3">
                    <label for="exampleInputPassword1">Quantidade</label>
                    <input name="qnt" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade">
                  </div>
              ...
              <div class="card-footer clearfix">
                <button type="submit" class="btn btn-success float-right"><i class="fas fa-plus"></i>Cadastrar Produto</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
